...
#line hidden
            ...
            table1.AddRow(new string[] {
                        "E:\\aa\\sp2"});
#line 7
 testRunner.Given("I have following files to be arranged", ((string)(null)), table1, "Given ");
#line 14
 testRunner.When("I start smart arrange", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 15
 testRunner.Then("the result should be `E:\\aa\\sp`", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
